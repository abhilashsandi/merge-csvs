20e0e69 fix(dps): address review feedback for DpsScheduler
bdfe540 fix(ui): update interval, captcha strategy, and fix stale closure in DpsScheduler
b97d198 feat: add Next.js UI for DPS scheduler
 app/dl/page.tsx                  |  19 ++
 backend/src/Interfaces/Config.ts |   3 +-
 components/DpsScheduler.tsx      | 421 +++++++++++++++++++++++++++++++++++++++
 3 files changed, 442 insertions(+), 1 deletion(-)
diff --git a/app/dl/page.tsx b/app/dl/page.tsx
new file mode 100644
index 0000000..778c9c7
--- /dev/null
+++ b/app/dl/page.tsx
@@ -0,0 +1,19 @@
...
+export type { Config };
+export { configZod };
diff --git a/components/DpsScheduler.tsx b/components/DpsScheduler.tsx
new file mode 100644
index 0000000..a20402f
--- /dev/null
+++ b/components/DpsScheduler.tsx
@@ -0,0 +1,421 @@
+'use client';
+
...
+                    setLogs(prev => [...prev, 'ΓÜá∩╕Å ACTION REQUIRED: Captcha solver token needed to proceed.']);
