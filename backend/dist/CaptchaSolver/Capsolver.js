...
exports.CapSolverGetResult = exports.CapSolverCreateTask = void 0;
const axios_1 = __importDefault(require("axios"));
const log = __importStar(require("../Log"));
const captchaClient = axios_1.default.create({ baseURL: 'https://api.capsolver.com' });
const CapSolverCreateTask = async (clientKey) => {
...
exports.CapSolverCreateTask = CapSolverCreateTask;
const CapSolverGetResult = async (taskId, clientKey) => {
...
exports.CapSolverGetResult = CapSolverGetResult;
